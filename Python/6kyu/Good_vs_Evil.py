...
def good_vs_evil(good, evil):
    good_dict = {0: 1, 1: 2, 2: 3, 3: 3, 4: 4, 5: 10}
    evil_dict = {0: 1, 1: 2, 2: 2, 3: 2, 4: 3, 5: 5, 6: 10}
    evil_sum = 0
    good_sum = 0
    for idx, value in enumerate(good.split()):
        good_sum += good_dict[idx] * int(value)
    for idx, value in enumerate(evil.split()):
        evil_sum += evil_dict[idx] * int(value)
