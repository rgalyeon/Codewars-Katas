...
directly opposite but they become directly opposite after the reduction of "EAST" and "WEST" so
...
def dir_reduc(arr):
    ...
    for direction in arr:
        if stack and stack[-1] == directions[direction]:
            stack.pop()
        else:
